...
urlpatterns = [
    ...
    path('car/category/create/', views.CarsCategoryCreateUpdateDestroyViewSet.as_view({'post': 'create'})),
    ...
    path('car/category/update/<int:pk>/', views.CarsCategoryCreateUpdateDestroyViewSet.as_view({'put': 'update'})),
    path('car/category/destroy/<int:pk>/', views.CarsCategoryCreateUpdateDestroyViewSet.as_view({'delete': 'destroy'})),
